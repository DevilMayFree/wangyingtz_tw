                            ...
                            <div class="row">
                                    ...
                                    <div class="footer-logo">
                                        <a href="index.html" :title="$root.$data.companyName">
                                            <picture>
                                                ...
                                                <img src="images/logo_white.png?v=20210701_4" style="height: 60px;width: 60px;" :alt="$root.$data.companyName" />
                                            </picture>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-lg-10 col-md-24">
                                    <div class="footer-companyInfo">
                                       ...
                                       <!--Facebook:「旺盈投資」<span v-if="$root.$data.windowWidth > 767"> | </span> Email:zxie9807@gmail.com<span v-if="$root.$data.windowWidth > 767"> | </span><br v-if="$root.$data.windowWidth < 768"/>地址：新北市三重區萬全街1號2樓 
                                        --><br/>
...
var content = new Vue({
    ...
    data: {
        ...
        newsList: [
            {
                tit: `鼎邦旗下在台總代理基金移轉之重要公告`,
                link: `doc/public-annoucement-hp-15-03-2021.pdf`,
                blank: true,
            },
            {
                tit: `鼎邦防制洗錢及打擊資恐內部控制制度聲明書`,
